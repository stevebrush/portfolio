                    ...
                    '{{#each previews}}',
                        '<li class="flickr-preview-list-item">',
                            '<div class="th thumbnail">',
                                '<a class="swipebox" rel="alumni_gallery_{{../info.relationship}}" href="{{this.src_lg}}" title="{{this.title}}">',
            ...
            '<div class="flickr-detail">',
                ...
                '<div class="row">',
                    '{{#each photos}}',
                        '<div class="small-3 columns col-sm-3">',
                            '<div class="th thumbnail">',
                                '<a class="swipebox" rel="alumni_gallery_{{../relationship}}" href="{{this.src_lg}}" title="{{this.title}}">',
                                    '<img src="{{this.src_sm}}">',
                                '</a>',
                            '</div>',
                        '</div>',
